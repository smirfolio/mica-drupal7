...
<div class="row sm-bottom-margin document-item-list flex-row" test-ref="study">
  ...
  <div class="col-md-10  col-sm-12 col-xs-12">
    <div>
      <h4>
        <?php print DrupalMicaStudyResource::harmoStudyListItem($study); ?>
      </h4>
      <hr class="no-margin">
    ...
    <?php if (variable_get_value('harmo_studies_list_show_study_sup_info')): ?>
      ...
      <?php endif; ?>
        <div class="sm-top-margin">
          ...
          $dataschema_var_caption = $dataschema_vars < 2 ? $localize->getTranslation('metrics.mica.harmonization-study-variable') : $localize->getTranslation('metrics.mica.harmonization-study-variables');
