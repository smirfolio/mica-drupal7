...
<div>
  <p>
    <?php if (!empty($study_dto->logo->id)): ?>
      <img src="<?php print mica_obiba_commons_safe_expose_server_url($study_dto->id, $study_dto->logo, 'study') ?>"
        class="imageThumb">
    <?php endif; ?>
    <?php print mica_obiba_commons_get_localized_field($study_dto, 'objectives'); ?>
  </p>
    ...
    <table class="table table-striped">
      ...
      <?php if (!empty($study_dto->acronym)): ?>
        <tr>
          ...
          <td><p><?php print mica_obiba_commons_get_localized_field($study_dto, 'acronym'); ?></p></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if (!empty($study_dto->website)): ?>
        <tr>
          ...
          <td>
            <p><?php
              print l(mica_obiba_commons_get_localized_field($study_dto, 'acronym') . ' ' . t('website'),
                $study_dto->website,
              ...
              <?php foreach ($study_dto->investigators as $key_investigator => $investigator) : ?>
                <li>
                  <a href="#" data-toggle="modal"
                    ...
                    ( <?php print mica_obiba_commons_get_localized_field($investigator->institution, 'name'); ?>
                    )
                  </a>
                </li>
              <?php endforeach; ?>
              ...
              <?php foreach ($study_dto->contacts as $key_contact => $contact) : ?>
                <li>
                  <a href="#" data-toggle="modal"
                    ...
                    ( <?php print mica_obiba_commons_get_localized_field($contact->institution, 'name'); ?>
                    )
                  </a>
                </li>
              <?php endforeach; ?>
    ...
    <table class="table table-striped">
            ...
            <ul>
              <?php foreach ($study_dto->methods->designs as $design): ?>
                <li>
                  <?php print t($design); ?>
                  <?php if ($design == 'other'): ?>
                    : <?php print mica_obiba_commons_get_localized_field($study_dto->methods, 'otherDesign'); ?>
                  <?php endif; ?>
                </li>
              <?php endforeach; ?>
            </ul>
      ...
      <?php if (!empty($study_dto->methods->followUpInfo)): ?>
        <tr>
          ...
          <td><p><?php print mica_obiba_commons_get_localized_field($study_dto->methods, 'followUpInfo'); ?></p>
          </td>
        </tr>
      <?php endif; ?>
              ...
              <?php foreach ($study_dto->methods->recruitments as $recruitment): ?>
                <li>
                  ...
                  <?php if ($recruitment == 'other'): ?>
                    : <?php print mica_obiba_commons_get_localized_field($study_dto->methods, 'otherRecruitment'); ?>
                  <?php endif; ?>
                </li>
              <?php endforeach; ?>
            </ul>
      ...
      <?php if (!empty($study_dto->numberOfParticipants->info)): ?>
        <tr>
          ...
          <td>
            <p><?php print mica_obiba_commons_get_localized_field($study_dto->numberOfParticipants, 'info'); ?></p>
          </td>
        </tr>
      <?php endif; ?>
      ...
      <?php if (!empty($study_dto->methods->info)): ?>
        <tr>
          ...
          <td><p><?php print mica_obiba_commons_get_localized_field($study_dto->methods, 'info'); ?></p></td>
        </tr>
      <?php endif; ?>
      </tbody>
    </table>
              ...
              <td>
                <p>
                  ...
                  <?php if (!empty($study_dto->otherAccess)): ?>
                    (<?php print mica_obiba_commons_get_localized_field($study_dto, 'otherAccess'); ?>)
                  <?php endif; ?>
                </p>
              </td>
            </tr>
...
<?php if (!empty($study_dto->info)): ?>
  <section>
    ...
    <p><?php print mica_obiba_commons_get_localized_field($study_dto, 'info'); ?></p>
  </section>
<?php endif; ?>
            ...
            <?php foreach ($populations as $key => $population): ?>
              <li <?php if ($key == array_keys($populations)[0]) {
                ...
                <a href="#population-<?php print $key; ?>" data-toggle="pill">
                  <?php print mica_obiba_commons_get_localized_field($population['data'], 'name'); ?>
                </a>
              </li>
...
<?php if (!empty($coverage)): ?>
  <section>
    ...
    <?php foreach ($coverage as $taxonomy_coverage): ?>
      <h4><?php print mica_obiba_commons_get_localized_field($taxonomy_coverage['taxonomy'], 'titles'); ?></h4>

      <p class="help-block">
        <?php print mica_obiba_commons_get_localized_field($taxonomy_coverage['taxonomy'], 'descriptions'); ?>
      </p>
