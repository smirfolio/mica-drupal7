  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php print mica_obiba_commons_get_localized_field($dce, 'name'); ?></h4>
      </div>
        ...
        <section>
          <div>
            <?php if (!empty($dce->description)): ?>
              <p>
                <?php print mica_obiba_commons_get_localized_field($dce, 'description'); ?>
              </p>
            <?php endif; ?>
          ...
          <table class="table table-striped">
            ...
            <?php if (!empty($dce->startYear)): ?>
              <tr>
                ...
                <td><p><?php print mica_obiba_commons_format_year($dce->startYear, $dce->startMonth); ?></p></td>
              </tr>
            <?php endif; ?>
            ...
            <?php if (!empty($dce->endYear)): ?>
              <tr>
                ...
                <td><p><?php print mica_obiba_commons_format_year($dce->endYear, $dce->endMonth); ?></p></td>
              </tr>
            <?php endif; ?>
                ...
                <td>
                  <ul>
                    ...
                    <?php if (!empty($dce->otherDataSources)): ?>
                      <li>
                        <?php print mica_obiba_commons_get_localized_field($dce, 'otherDataSources'); ?>
                      </li>
                    <?php endif; ?>
                  </ul>
                </td>
                ...
                <td>
                  <ul>
                    ...
                    <?php if (!empty($dce->otherBioSamples)): ?>
                      <li>
                        <?php print mica_obiba_commons_get_localized_field($dce, 'otherBioSamples'); ?>
                      </li>
                    <?php endif; ?>
                  </ul>
                </td>
            ...
            <?php if (!empty($dce->tissueTypes)): ?>
              <tr>
                ...
                <td><p><?php print mica_obiba_commons_get_localized_field($dce, 'tissueTypes'); ?></p></td>
              </tr>
            <?php endif; ?>
