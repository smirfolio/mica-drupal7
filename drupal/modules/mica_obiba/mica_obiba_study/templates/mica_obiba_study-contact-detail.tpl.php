                  ...
                  <td>
                    <div>
                      <?php !empty($contact->institution->name) ? //
                        print t('Name') . ' : ' . mica_obiba_commons_get_localized_field($contact->institution, 'name') : ''; ?>
                    </div>
                    <div>
                      <?php !empty($contact->institution->department) ?
                        print t('Department') . ' : ' . mica_obiba_commons_get_localized_field($contact->institution, 'department') : ''; ?></li>
                    </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>   <?php !empty($contact->institution->address->street) ? print t('Street') . ' : ' .
                          mica_obiba_commons_get_localized_field($contact->institution->address, 'street') : ''; ?> </div>
                      <div>  <?php !empty($contact->institution->address->city) ?
                          print t('City') . ' : ' . mica_obiba_commons_get_localized_field($contact->institution->address, 'city') : ''; ?></div>
