...
?>
  ...
  <div>
    <h4 class="pull-left no-top-margin">
      <?php print  mica_obiba_commons_get_localized_field($population, 'name') ?>
    </h4>
...
<?php if (!empty($population->description)): ?>
  <p>
    <?php print mica_obiba_commons_get_localized_field($population, 'description'); ?>
  </p>
<?php endif; ?>
        ...
        <table class="table table-striped">
          ...
          <?php if (!empty($population->numberOfParticipants->participant->number)): ?>
            <tr>
              ...
              <td>
                ...
                <p><?php print mica_obiba_commons_get_localized_field($population->numberOfParticipants, 'info'); ?></p>
                <?php endif; ?>
                </p>
              </td>
            </tr>
          ...
          <?php if (!empty($population->info)): ?>
            <tr>
              ...
              <td><p> <?php print mica_obiba_commons_get_localized_field($population, 'info'); ?></p></td>
            </tr>
          <?php endif; ?>
        ...
        <table class="table table-striped">
          ...
          <?php if (!empty($population->recruitment->generalPopulationSources)): ?>
            <tr>
              ...
              <td><?php mica_obiba_commons_iterate_field($population->recruitment->generalPopulationSources); ?></td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->recruitment->studies)): ?>
            <tr>
              ...
              <td>
                <?php
                $studies = mica_obiba_commons_get_localized_dtos_field($population->recruitment, 'studies');
                ?>
                <?php mica_obiba_commons_iterate_field($studies); ?>
              </td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->recruitment->specificPopulationSources)): ?>
            <tr>
              ...
              <td><?php mica_obiba_commons_iterate_field($population->recruitment->specificPopulationSources); ?></td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->recruitment->otherSpecificPopulationSource)): ?>
            <tr>
              ...
              <td><?php print mica_obiba_commons_get_localized_field($population->recruitment, 'otherSpecificPopulationSource'); ?></td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->recruitment->otherSource)): ?>
            <tr>
              <td><h5><?php print t('Supplementary information') ?></h5></td>
              <td><?php print mica_obiba_commons_get_localized_field($population->recruitment, 'otherSource'); ?></td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->recruitment->info)): ?>
            <tr>
              <td><h5><?php print t('Supplementary information') ?></h5></td>
              <td><?php print mica_obiba_commons_get_localized_field($population->recruitment, 'info'); ?></td>
            </tr>
          <?php endif; ?>
          </tbody>
        </table>
        ...
        <table class="table table-striped">
          ...
          <?php if (isset($population->selectionCriteria->gender) && ($population->selectionCriteria->gender === 0 || $population->selectionCriteria->gender === 1)): ?>
            <tr>
              ...
              <td><?php print  mica_obiba_study_get_gender($population->selectionCriteria->gender); ?></td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->selectionCriteria->countriesIso)): ?>
            <tr>
              ...
              <td>
                <?php mica_obiba_commons_iterate_field($population->selectionCriteria->countriesIso,
          ...
          <?php if (!empty($population->selectionCriteria->ethnicOrigin)): ?>
            <tr>
              ...
              <td>
                <?php $ehtnic_origins = mica_obiba_commons_get_localized_dtos_field($population->selectionCriteria, 'ethnicOrigin'); ?>
                <?php mica_obiba_commons_iterate_field($ehtnic_origins); ?>
              </td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->selectionCriteria->healthStatus)): ?>
            <tr>
              ...
              <td>
                <?php $health_status = mica_obiba_commons_get_localized_dtos_field($population->selectionCriteria, 'healthStatus'); ?>
                <?php mica_obiba_commons_iterate_field($health_status); ?>
              </td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->selectionCriteria->otherCriteria)): ?>
            <tr>
              ...
              <td><?php print mica_obiba_commons_get_localized_field($population->selectionCriteria, 'otherCriteria'); ?></td>
            </tr>
          <?php endif; ?>
          ...
          <?php if (!empty($population->selectionCriteria->info)): ?>
            <tr>
              <td><h5><?php print t('Supplementary information') ?></h5></td>
              <td><?php print mica_obiba_commons_get_localized_field($population->selectionCriteria, 'info'); ?></td>
            </tr>
          <?php endif; ?>
