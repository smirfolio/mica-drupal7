...
<div xmlns="http://www.w3.org/1999/html">
  <?php if (!empty($network_dto->description)): ?>
    <p><?php print mica_obiba_commons_get_localized_field($network_dto, 'description'); ?></p>
  <?php endif; ?>
    ...
    <div class="row">
        ...
        <table class="table table-striped">
          ...
          <?php if (!empty($network_dto->acronym)): ?>
            <tr>
              ...
              <td><p><?php print mica_obiba_commons_get_localized_field($network_dto, 'acronym'); ?></p></td>
            </tr>
          <?php endif; ?>
      ...
      <div class="col-lg-6 col-xs-12">
        <?php if (!empty($network_dto->attributes)): ?>
          ...
          <p><?php print mica_obiba_dataset_attributes_tab($network_dto->attributes, 'maelstrom'); ?></p>
        <?php endif; ?>
      </div>
    </div>
  ...
  <section>
    ...
    <div class="row">
      <div class="col-lg-12 col-xs-12">
        <div class="scroll-content-tab">
          <?php print mica_obiba_network_study_table($network_dto); ?>
        </div>
      </div>
    </div>
  </section>
