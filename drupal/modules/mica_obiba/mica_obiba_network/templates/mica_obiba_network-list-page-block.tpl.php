...
<div class="row sm-bottom-margin document-item-list flex-row">
  ...
  <div class="col-md-10  col-sm-12 col-xs-12">
    <div>
      <h4>
        <?php
        $acronym = mica_obiba_commons_get_localized_field($network, 'acronym');
      ...
      <p class="md-top-margin">
        <small>
          <?php print empty($network->description) ? '' :
            truncate_utf8(strip_tags(mica_obiba_commons_get_localized_field($network, 'description')), 250, TRUE, TRUE);; ?>
        </small>
      </p>
    </div>
