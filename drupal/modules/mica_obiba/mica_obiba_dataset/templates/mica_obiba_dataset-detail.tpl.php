    ...
    <div class="row">
        ...
        <table class="table table-striped">
          ...
          <?php if (!empty($dataset_dto->description)): ?>
            <tr>
              ...
              <td><p><?php print mica_obiba_commons_get_localized_field($dataset_dto, 'description'); ?></p></td>
            </tr>
          <?php endif; ?>
          <?php if (!empty($dataset_dto->acronym)): ?>
            <tr>
              <td><h5><?php print t('Acronym') ?></h5></td>
              <td><p><?php print mica_obiba_commons_get_localized_field($dataset_dto, 'acronym'); ?></p></td>
            </tr>
          <?php endif; ?>
      ...
      <div class="col-lg-6 col-xs-12">
        <?php if (!empty($dataset_dto->attributes)): ?>
          ...
          <p><?php print mica_obiba_dataset_attributes_tab($dataset_dto->attributes, 'maelstrom'); ?></p>
        <?php endif; ?>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-xs-12">
            <div class="scroll-content-tab">
              <?php print mica_obiba_dataset_study_tables_table($dataset_type_dto) ?>
            </div>
          </div>
        </div>
      <?php else: ?>
            ...
            <div class="col-lg-6 col-xs-12">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <p>
                      <?php print l(mica_obiba_commons_get_localized_field($dataset_type_dto->studyTable->studySummary, 'acronym') . ' - ' . mica_obiba_commons_get_localized_field($dataset_type_dto->studyTable->studySummary, 'name'), 'mica/study/' . $dataset_type_dto->studyTable->studySummary->id . '/' . mica_obiba_commons_to_slug(mica_obiba_commons_get_localized_field($dataset_type_dto->studyTable->studySummary, 'name'))); ?>
                    </p>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    ?>
                    <?php print mica_obiba_commons_get_localized_field($population_summary, 'name'); ?>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <?php foreach ($population_summary->dataCollectionEventSummaries as $dce_summary) {
                      if ($dce_summary->id == $dataset_type_dto->studyTable->dataCollectionEventId) {
                        print mica_obiba_commons_get_localized_field($dce_summary, 'name');
                        break;
                      }
                    }
                    ?>
