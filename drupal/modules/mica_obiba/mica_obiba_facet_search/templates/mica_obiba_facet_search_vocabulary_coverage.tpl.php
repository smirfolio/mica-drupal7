...
<?php if (!empty($vocabulary_coverage->hits)): ?>
  ...
  <p class="help-block">
    <?php print mica_obiba_commons_get_localized_field($vocabulary_coverage->vocabulary, 'descriptions'); ?>
  </p>
    ...
    <table class="table table-striped fix-first-column ">
      ...
      <?php foreach ($vocabulary_coverage->terms as $key_term => $term_coverage) : ?>
        <tr data-toggle="tooltip"
          title="<?php print mica_obiba_commons_get_localized_field($term_coverage->term, 'descriptions'); ?>">
          <td style="vertical-align: middle; word-wrap:break-word;" class="right-border">
            <?php if (empty($term_coverage->hits)): ?>
              <?php print mica_obiba_commons_get_localized_field($term_coverage->term, 'titles'); ?>
            <?php else: ?>
              <?php print l(mica_obiba_commons_get_localized_field($term_coverage->term, 'titles'), 'mica/search',
                array(
                  'query' => array(
                    'type' => 'variables',
                    'query' => MicaClient::add_parameter_dto_query_link(array(
