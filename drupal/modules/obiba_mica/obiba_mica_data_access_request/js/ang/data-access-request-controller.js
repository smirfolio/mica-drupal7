  ...
  Drupal.behaviors.obiba_mica_data_access_request_controller = {
    attach: function (context, settings) {
      ...
      Drupal.settings.dataAccessRequest
        ...
        .controller('DataAccessRequestListController', ['$rootScope', '$scope', '$route', '$routeParams', '$location', 'DataAccessRequestsResource', 'DataAccessRequestResource', 'DataAccessRequestService', 'NOTIFICATION_EVENTS',
