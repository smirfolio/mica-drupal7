  ...
  Drupal.behaviors.obiba_mica_data_access_request_controller = {
    attach: function (context, settings) {
      ...
      mica.dataAccessRequest
        .controller('DataAccessRequestListController', ['$rootScope', '$scope', '$route', '$routeParams', '$location',
          'DataAccessRequestsResource', 'DataAccessRequestResource', 'DataAccessRequestService', 'NOTIFICATION_EVENTS',

          function ($rootScope, $scope, $route, $routeParams, $location, DataAccessRequestsResource, DataAccessRequestResource, DataAccessRequestService, NOTIFICATION_EVENTS) {
            $scope.drupalBaseUrl = Drupal.settings.angularjsApp.basePath;
