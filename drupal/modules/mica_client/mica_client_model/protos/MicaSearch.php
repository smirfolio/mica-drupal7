...
namespace obiba\mica\RangeFilterQueryDto {
...
namespace obiba\mica\RangeFilterQueryDto {
  ...
  class Condition extends \DrSlump\Protobuf\Message {
    ...
    /**  @var int - \obiba\mica\RangeFilterQueryDto\Operator */
    public $op = NULL;
    ...
    public static function descriptor() {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'obiba.mica.RangeFilterQueryDto.Condition');
      ...
      $f->type = \DrSlump\Protobuf::TYPE_ENUM;
      $f->rule = \DrSlump\Protobuf::RULE_REQUIRED;
      $f->reference = '\obiba\mica\RangeFilterQueryDto\Operator';
      $descriptor->addField($f);
     ...
     * Clear <op> value
     *
     * @return \obiba\mica\RangeFilterQueryDto\Condition
     */
     ...
     * Get <op> value
     *
     * @return int - \obiba\mica\RangeFilterQueryDto\Operator
     */
     ...
     * Set <op> value
     *
     * @param int - \obiba\mica\RangeFilterQueryDto\Operator $value
     * @return \obiba\mica\RangeFilterQueryDto\Condition
     */
...
namespace obiba\mica {
  ...
  class RangeFilterQueryDto extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \obiba\mica\RangeFilterQueryDto\Condition */
    public $from = NULL;
    ...
    public static function descriptor() {
      ...
      $f->type = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\obiba\mica\RangeFilterQueryDto\Condition';
      $descriptor->addField($f);
     ...
     * Set <from> value
     *
     * @param \obiba\mica\RangeFilterQueryDto\Condition $value
     * @return \obiba\mica\RangeFilterQueryDto
     */
    public function setFrom(\obiba\mica\RangeFilterQueryDto\Condition $value) {
      return $this->_set(1, $value);
    }
     ...
     * @return \obiba\mica\RangeFilterQueryDto
     */
    public function setTo(\obiba\mica\RangeFilterQueryDto\Condition $value) {
      return $this->_set(2, $value);
    }
  }
}
