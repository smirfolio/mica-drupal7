...
namespace obiba\mica {
  ...
  class NetworksResultDto extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'obiba.mica.NetworksResultDto');
     ...
     *
     * @return \obiba\mica\NetworksResultDto
     */
...
namespace {
  ...
  \obiba\mica\QueryResultDto::extension(function(){
      // OPTIONAL MESSAGE obiba.mica.NetworksResultDto.result = 1004
    $f = new \DrSlump\Protobuf\Field();
    $f->number    = 1004;
    $f->name      = "obiba.mica.NetworksResultDto.result";
    $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
    $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
    $f->reference = '\obiba\mica\NetworksResultDto';
    return $f;
  });
