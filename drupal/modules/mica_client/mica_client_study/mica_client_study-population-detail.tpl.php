      ...
      <?php if (!empty($context_population_detail->numberOfParticipants->participant->number)): ?>
        <div class="field field-label-inline clearfix">
          ...
          <div class="field-items">
            ...
            <div class="field-item odd">
              <?php print mica_client_commons_get_if_no_limit($context_population_detail->numberOfParticipants->participant->noLimit) ?>
            </div>
          </div>
        </div>
      <?php endif; ?>
      ...
      <?php if (!empty($context_population_detail->numberOfParticipants->sample->number)): ?>
        <div class="field field-label-inline clearfix">
          ...
          <div class="field-items">
            ...
            <div class="field-item odd">
              <?php print mica_client_commons_get_if_no_limit($context_population_detail->numberOfParticipants->sample->noLimit) ?>
            </div>
          </div>
        </div>
      <?php endif; ?>
