...
<div id="search-facets">
  ...
  <div class="tab-content">
    <div class="tab-pane" id="variable-facet"> <?php print render($mica_client_variable); ?></div>
    <div class="tab-pane active" id="study-facet"> <?php print  render($mica_client_study); ?></div>
