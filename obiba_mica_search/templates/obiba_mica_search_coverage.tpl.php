...
<div>
  ...
  <div
    class="pull-right facet-search-form"><?php print render($variable_search_form); ?></div>
  ...
  <ul class="nav nav-pills pull-right">
    <li
      class="<?php if (!empty($group_by) && $group_by == 'studyIds') print 'active' ?>"
      data-toggle="tooltip"
    ...
    <li
      class="<?php if (!empty($group_by) && $group_by == 'dceIds') print 'active' ?>"
      data-toggle="tooltip"
      data-placement="top"
      title="<?php print t('Group by data collection event') ?>">
      <?php
      print MicaClientAnchorHelper::ajaxFriendlyAnchor(
        MicaClientPathProvider::COVERAGE,
    ...
    <li
      class="<?php if (!empty($group_by) && $group_by == 'datasetId') print 'active' ?>"
      data-toggle="tooltip"
